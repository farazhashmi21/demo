...
<head>
  ...
  <title>Hashmi Lab</title>
  <link rel="stylesheet" type="text/css" href="assets/css/style.css">
</head>
<body>

<!-- Web Template: https://themeht.com/template/labortech/html/index-2.html -->
...
<section class="banner p-0 pos-r">
  <div class="banner-slider owl-carousel no-pb owl-loaded owl-drag" data-dots="false" data-nav="true">
    
    
  <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-4098px, 0px, 0px); transition: all 0.25s ease 0s; width: 8196px;"><div class="owl-item cloned" style="width: 1366px;"><div class="item overlay-50 theme-overlay" data-bg-img="images/bg/03.jpg" data-overlay="9" style="background-image: url(&quot;images/bg/03.jpg&quot;);">
      <div class="container">
        <div class="row pt-8 custom-pb-2">
          <div class="col-lg-6 col-md-8 col-12">
            ...
            <div class="btn-box mt-5">
              <a class="btn btn-white" href="about-us.html"> <span>More About</span>
              </a>
    ...
    </div></div><div class="owl-item cloned" style="width: 1366px;"><div class="item overlay-50 theme-overlay" data-bg-img="images/bg/02.jpg" data-overlay="9" style="background-image: url(&quot;images/bg/02.jpg&quot;);">
      <div class="container">
        <div class="row pt-8 custom-pb-2">
          <div class="col-lg-6 col-md-8 col-12">
            <h1 class="mb-4 text-white">Providing Best Laboratory Service</h1>
    ...
    </div></div><div class="owl-item" style="width: 1366px;"><div class="item overlay-50 theme-overlay" data-bg-img="images/bg/03.jpg" data-overlay="9" style="background-image: url(&quot;images/bg/03.jpg&quot;);">
      <div class="container">
        <div class="row pt-8 custom-pb-2">
          <div class="col-lg-6 col-md-8 col-12">
            <h1 class="mb-4 text-white">Providing Best Laboratory Service</h1>
    ...
    </div></div><div class="owl-item active" style="width: 1366px;"><div class="item overlay-50 theme-overlay" data-bg-img="images/bg/02.jpg" data-overlay="9" style="background-image: url(&quot;images/bg/02.jpg&quot;);">
      <div class="container">
        <div class="row pt-8 custom-pb-2">
          <div class="col-lg-6 col-md-8 col-12">
            <h1 class="mb-4 text-white">Providing Best Laboratory Service</h1>
    ...
    </div></div><div class="owl-item cloned" style="width: 1366px;"><div class="item overlay-50 theme-overlay" data-bg-img="images/bg/03.jpg" data-overlay="9" style="background-image: url(&quot;images/bg/03.jpg&quot;);">
      <div class="container">
        <div class="row pt-8 custom-pb-2">
          <div class="col-lg-6 col-md-8 col-12">
            <h1 class="mb-4 text-white">Providing Best Laboratory Service</h1>
    ...
    </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><span class="las la-angle-left"><span></span></span></button><button type="button" role="presentation" class="owl-next"><span class="las la-angle-right"></span></button></div><div class="owl-dots disabled"></div></div>
</section>
          ...
          <div class="row g-0">
            <div class="col-lg-4">
              <div class="featured-item py-5 shadow-none d-flex align-items-start style-2 border-end border-light border-bottom">
                <div class="featured-icon me-3"> <i class="flaticon-laboratory-1"></i>
                </div>
                <div class="featured-desc">
                  <div class="featured-title">
                    <h5 class="mt-0">laboratory Technician</h5>
                  </div>
                  <p class="mb-3">Our firm is expert to create an efficient user interface that.</p> <a class="btn-link text-black" href="#">Read More...</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="featured-item py-5 shadow-none d-flex align-items-start style-2 border-end border-light border-bottom">
                <div class="featured-icon me-3"> <i class="flaticon-laboratory"></i>
                </div>
                <div class="featured-desc">
                  <div class="featured-title">
                    <h5 class="mt-0">Pathologycam Testing</h5>
                  </div>
                  <p class="mb-3">Our firm is expert to create an efficient user interface that.</p> <a class="btn-link text-black" href="#">Read More...</a>
                </div>
              </div>
            ...
            <div class="col-lg-4">
              <div class="featured-item py-5 shadow-none d-flex align-items-start style-2 border-end border-light border-bottom">
                <div class="featured-icon me-3"> <i class="flaticon-biology-1"></i>
                </div>
                <div class="featured-desc">
                  <div class="featured-title">
                    <h5 class="mt-0">Chemical Pathology</h5>
                  </div>
                  <p class="mb-3">Our firm is expert to create an efficient user interface that.</p> <a class="btn-link text-black" href="#">Read More...</a>
                </div>
              </div>
      ...
      <div class="col-lg-6 col-12 pe-md-6">
        <div class=" position-relative">
          <div class="me-sm-8 mb-10">
            <img class="img-fluid img-border box-shadow w-100" src="images/about/03.jpg" alt="">
          </div>
          <div class="position-absolute bottom-0 ms-8 mb-n10">
            <img class="img-fluid img-border box-shadow z-index-1" src="images/about/02.jpg" alt="">
          </div>
        </div>
      </div>
...
<section class="p-0">
  <div class="container">
    <div class="row">
      <div class="col">
        <div class="dark-bg px-md-7 px-4 pt-7 pb-9" data-bg-img="images/pattern/02.png" style="background-image: url(&quot;images/pattern/02.png&quot;);">
  ...
  <div class="container-fluid px-lg-6 light-bg">
    <div class="row">
      <div class="col mt-n10">
        <div class="owl-carousel owl-loaded owl-drag" data-dots="false" data-items="3" data-md-items="2" data-sm-items="1" data-xs-items="1" data-margin="30">
          
          
          
          
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1268px, 0px, 0px); transition: all 0s ease 0s; width: 4227px;"><div class="owl-item cloned" style="width: 392.667px; margin-right: 30px;"><div class="item">
            <div class="service-item style-2 active">
              <div class="service-img position-relative overflow-hidden">
                <img class="img-fluid" src="images/services/02.jpg" alt=""> <a class="link-btn" href="pharmaceutical-research.html"><i class="las la-long-arrow-alt-right"></i></a>
              </div>
          ...
          </div></div><div class="owl-item cloned" style="width: 392.667px; margin-right: 30px;"><div class="item">
            <div class="service-item style-2">
              <div class="service-img position-relative overflow-hidden">
                <img class="img-fluid" src="images/services/03.jpg" alt=""> <a class="link-btn" href="pathologycam-testing.html"><i class="las la-long-arrow-alt-right"></i></a>
              </div>
              <div class="service-desc white-bg shadow-none">
                <div class="service-title">
            ...
            <div class="service-item style-2">
              <div class="service-img position-relative overflow-hidden">
                <img class="img-fluid" src="images/services/04.jpg" alt=""> <a class="link-btn" href="chemical-research.html"><i class="las la-long-arrow-alt-right"></i></a>
              </div>
              <div class="service-desc white-bg shadow-none">
                <div class="service-title">
          ...
          </div></div><div class="owl-item active" style="width: 392.667px; margin-right: 30px;"><div class="item">
            <div class="service-item style-2">
              <div class="service-img position-relative overflow-hidden">
                <img class="img-fluid" src="images/services/01.jpg" alt=""> <a class="link-btn" href="biochemistry-solution.html"><i class="las la-long-arrow-alt-right"></i></a> 
              </div>
              <div class="service-desc white-bg shadow-none">
                <div class="service-title">
          ...
          </div></div><div class="owl-item" style="width: 392.667px; margin-right: 30px;"><div class="item">
            <div class="service-item style-2">
              <div class="service-img position-relative overflow-hidden">
                <img class="img-fluid" src="images/services/04.jpg" alt=""> <a class="link-btn" href="chemical-research.html"><i class="las la-long-arrow-alt-right"></i></a>
              </div>
          ...
          </div></div></div></div><div class="owl-nav disabled"><button type="button" role="presentation" class="owl-prev"><span class="las la-long-arrow-alt-left"><span></span></span></button><button type="button" role="presentation" class="owl-next"><span class="las la-long-arrow-alt-right"></span></button></div><div class="owl-dots disabled"></div></div>
      </div>
    </div>
  </div>
</section>
...
<section class="parallaxie" data-bg-img="images/bg/04.jpg" style="background-image: url(&quot;https://themeht.com/template/labortech/html/images/bg/04.jpg&quot;); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 1602.88px;">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-8 col-11 ms-auto">
        <div class="white-bg box-shadow p-4 p-md-5 z-index-1">
          <div class="section-title mb-4">
            <h2 class="title mb-0">Please Form Fill Below</h2> 
          </div>
...
<section>
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <div class="owl-carousel no-pb popup-gallery owl-loaded owl-drag" data-dots="false" data-items="4" data-md-items="2" data-sm-items="1" data-xs-items="1" data-margin="10">
          
          
          
          
          
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1126px, 0px, 0px); transition: all 0s ease 0s; width: 3660px;"><div class="owl-item cloned" style="width: 271.5px; margin-right: 10px;"><div class="item">
          ...
          </div></div><div class="owl-item cloned" style="width: 271.5px; margin-right: 10px;"><div class="item">
            <div class="cases-item position-relative overflow-hidden">
          ...
          </div></div><div class="owl-item active" style="width: 271.5px; margin-right: 10px;"><div class="item">
            <div class="cases-item position-relative overflow-hidden">
          ...
          </div></div><div class="owl-item" style="width: 271.5px; margin-right: 10px;"><div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src="images/project/05.jpg" alt="">
              <a class="popup-img" href="images/project/large/05.jpg"> <i class="las la-plus"></i>
              </a>
    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6">
        <div class="counter d-flex">
          ...
          <div class="counter-desc"> <span class="count-number text-black" data-to="24" data-speed="2000">12</span>
      ...
      <div class="col-lg-3 col-sm-6 mt-5 mt-sm-0">
        <div class="counter d-flex">
          ...
          <div class="counter-desc"> <span class="count-number text-black" data-to="272" data-speed="2000">139</span>
      ...
      <div class="col-lg-3 col-sm-6 mt-5 mt-lg-0">
        <div class="counter d-flex">
          ...
          <div class="counter-desc"> <span class="count-number text-black" data-to="423" data-speed="2000">216</span>
      ...
      <div class="col-lg-3 col-sm-6 mt-5 mt-lg-0">
        <div class="counter d-flex">
          ...
          <div class="counter-desc"> <span class="count-number text-black" data-to="576" data-speed="2000">294</span>
  ...
  <div class="container">
    ...
    <div class="row align-items-center g-0">
      <div class="col-lg-4 col-md-6">
        <div class="price-table text-center dark-bg text-white" data-bg-img="images/pattern/02.png" style="background-image: url(&quot;images/pattern/02.png&quot;);">
...
<section class="p-0">
  <div class="container-fluid p-0">
    <div class="row g-0">
      <div class="col-md-4" data-bg-img="images/about/05.jpg" style="background-image: url(&quot;images/about/05.jpg&quot;);"></div>
      <div class="col-md-8 theme-bg py-5 px-lg-8 px-5">
        <div class="owl-carousel no-pb owl-loaded owl-drag" data-dots="false" data-items="1" data-autoplay="true" data-autoplay-timeout="8000">
          
          
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1437px, 0px, 0px); transition: all 0s ease 0s; width: 4313px;"><div class="owl-item cloned" style="width: 718.667px;"><div class="item">
          ...
          </div></div><div class="owl-item cloned" style="width: 718.667px;"><div class="item">
            <div class="testimonial text-center">
              <div class="testimonial-img mb-2">
                <img class="img-fluid rounded-circle shadow-sm d-inline-block" src="images/testimonial/01.jpg" alt="">
              </div>
          ...
          </div></div><div class="owl-item active" style="width: 718.667px;"><div class="item">
            <div class="testimonial text-center">
              <div class="testimonial-img mb-2">
                <img class="img-fluid rounded-circle shadow-sm d-inline-block" src="images/testimonial/01.jpg" alt="">
              </div>
          ...
          </div></div><div class="owl-item" style="width: 718.667px;"><div class="item">
            <div class="testimonial text-center">
              <div class="testimonial-img mb-2">
                <img class="img-fluid rounded-circle shadow-sm d-inline-block" src="images/testimonial/01.jpg" alt="">
              </div>
...
<a a href="mailto:developerfarazhashmi@yahoo.com">Email Me</a>
</body></html>