...
<div class="col-lg-5">
<div class="widget">
<div class="widget-title"><?php bloginfo('name'); ?></div>
<p class="mb-5">Copyright &#169; <script>document.write(new Date().getFullYear());</script>. INSPIRO.</p>
...
<div class="container">
<div class="copyright-text text-center">&copy; <script>document.write(new Date().getFullYear());</script>.
