...
if ( ! class_exists( 'corporate_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since corporate 1.0
	 */
	class corporate_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->register_control_type( 'corporate_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new corporate_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
